...
export  function Menu() {
  ...
  return (
    <>
      ...
      <Box>
      <Flex
        bg={useColorModeValue('blue.600', 'White.300')}
        ...
        borderBottom={1}
        borderStyle={'solid'}
        borderColor={useColorModeValue('white', 'White.300')}
        align={'center'}>
        <Flex
          flex={{ base: 1, md: 'auto' }}
          ml={{ base: -2 }}
        ...
        {/* menu */}
        <Flex flex={{ base: 1 }} justify={{ base: 'center', md: 'space-around', lg:'space-around' }}>
         <Heading 
